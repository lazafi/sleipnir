...
public class DLSResearch_EndDeviceOnly extends OffloadScheduler {

	public DLSResearch_EndDeviceOnly(MobileApplication A, MobileCloudInfrastructure I) {
		super();
	...
	public DLSResearch_EndDeviceOnly(Tuple2<MobileApplication,MobileCloudInfrastructure> t) {
		super();
